        ...
        <div id="wrapper">
            ...
            <div id="accordion">
                ...
                <div>
                    <!--
                    !!!READ THIS TRACY!!!
                    TODO : Change AccountConfirmation.jsp to something like reportBugsConfirmation.jsp
                    ...
                    <form role="form" id="create"  onSubmit="return validate();" action="AccountConfirmation.jsp" method="POST">
                        ...
                        <div class="form-group">
                            <label for="remarks">Describe the bugs and issues. Provide the page link where necessary.</label>
