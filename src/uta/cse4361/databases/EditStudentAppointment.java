 ...
 * @author Han
 */
public class EditStudentAppointment extends RDBImplCommand{
    
    private int id;
    private StudentAppointment appointment;
    ...
    public EditStudentAppointment (int apptID, StudentAppointment appt) {
        super();
        this.id = apptID;
